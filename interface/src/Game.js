...
const Game = ({playerName}) => {
    ...
    let {data: categorii, loading: loading1, error: error1} = useFetch("http://34.16.165.227:8080/categories/" + playerName);
    let {data: intrebari, loading: loading2, error: error2} = useFetch("http://34.16.165.227:8080/questions/" + playerName);
