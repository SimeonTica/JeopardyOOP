...
useFetchPost("http://34.16.195.23:8080/score/" + playerName, ans === "TRUE" ? intrebare.punctaj : 0)
...
useEffect(() => {
    const fetchData = async () => {
        let response = await fetch("http://34.16.195.23:8080/question/" + playerName, {
            method: 'POST',
            headers: {
        ...
        let responsePoints = await fetch("http://34.16.195.23:8080/score/" + playerName, {
            headers: {
